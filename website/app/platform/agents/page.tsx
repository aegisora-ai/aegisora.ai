    ...
    <div className="min-h-screen bg-white dark:bg-[#0d0d0f] text-slate-900 dark:text-slate-100 font-sans selection:bg-blue-100 dark:selection:bg-blue-900/50 transition-colors duration-300">
      ...
      <header className="flex items-center justify-between px-6 py-4 b order-b b order-slate-200 dark:b order-white/10 bg-white/90 dark:bg-[#0d0d0f]/90 backdrop-blur-md sticky top-0 z-50">
        ...
        <nav className="hidden lg:flex items-center gap-8 text-[14px] font-semibold text-slate-600 dark:text-slate-300">
          ...
          <Link href="/platform/agents" className="text-blue-600 dark:text-blue-400 transition-colors">Agent Governance</Link>
        ...
        <section className="relative max-w-[1400px] mx-auto px-6 md:px-12 pt-16 md:pt-28 pb-20 overflo w-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl z-10">
              ...
              >
                Treat autonomous agents like human employees. Assign strict cryptographic identities, define granular resource boundaries, and enforce the principle of least privilege at runtime.
              </motion.p>
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 b order-b b order-slate-100 dark:b order-white/5 bg-slate-50/50 dark:bg-transparent">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[15px] font-bold text-slate-900 dark:text-white">Financial Analyst Agent</div>
              ...
              <div className="p-6 space-y-6">
                <div>
                  <h4 className="text-[12px] font-bold text-slate-400 uppercase tracking-wider mb-3">Assigned Scopes</h4>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg border b order-slate-100 dark:b order-white/5 bg-slate-50 dark:bg-white/5">
                      ...
                      <div className="flex items-center gap-1.5">
                        <span className="text-[12px] font-mono text-slate-500">SELECT</span>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg border b order-slate-100 dark:b order-white/5 bg-slate-50 dark:bg-white/5">
                      ...
                      <div className="flex items-center gap-1.5">
                        <span className="text-[12px] font-mono text-blue-500">DROP, INSERT</span>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg border b order-slate-100 dark:b order-white/5 bg-slate-50 dark:bg-white/5">
                      ...
                      <div className="flex items-center gap-1.5">
                        <span className="text-[12px] font-mono text-slate-500">READ_ONLY</span>
                        <Check className="w-4 h-4 text-blue-500" />
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-[1400px] mx-auto px-6 md:px-12">
            <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              <p className="text-[18px] text-slate-600 dark:text-slate-400">
                Stop giving your AI models unrestricted access. Bind specific cryptographic identities to each agent and enforce strict boundaries.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white dark:bg-[#111113] border b order-slate-200 dark:b order-white/10 p-8 rounded-2xl">
                ...
                <h3 className="text-[20px] font-bold text-slate-900 dark:text-white mb-3">Verifiable Identity</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Every agent gets a unique, verifiable ID. Track exactly which model instance initiated an action, completely removing anonymity.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-[#111113] border b order-slate-200 dark:b order-white/10 p-8 rounded-2xl">
                ...
                <h3 className="text-[20px] font-bold text-slate-900 dark:text-white mb-3">Granular Scoping</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Define exact resource boundaries. A customer support agent should only read FAQs, never access billing databases.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-[#111113] border b order-slate-200 dark:b order-white/10 p-8 rounded-2xl">
                ...
                <h3 className="text-[20px] font-bold text-slate-900 dark:text-white mb-3">Dynamic Permissions</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Revoke or elevate access in real-time based on the user&apos;s own permissions, context shifts, or anomaly detection triggers.
                </p>
              </div>
            </div>
          </div>
