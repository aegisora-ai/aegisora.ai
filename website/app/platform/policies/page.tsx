            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-stretch gap-3">
                  ...
                  <div className="flex-1 p-3 rounded-lg border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 flex items-center gap-2">
                ...
                <div className="h-4 border-l-2 border-dashed border-slate-200 dark:border-white/10 ml-5"></div>

                {/* Outcome */}
                <div className="flex items-stretch gap-3">
                  <div className="pt-2">
                    <div className="px-2 py-1 rounded bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border border-blue-200 dark:border-blue-800/50 text-[11px] font-bold uppercase tracking-widest">THEN</div>
                  </div>
                  <div className="flex-1 p-3 rounded-lg border border-blue-200 dark:border-blue-900/30 bg-blue-50 dark:bg-blue-900/10 flex items-center gap-3">
