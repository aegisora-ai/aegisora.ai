    ...
    <div className="min-h-screen bg-white dark:bg-[#0d0d0f] text-slate-900 dark:text-slate-100 font-sans selection:bg-blue-100 dark:selection:bg-blue-900/50 transition-colors duration-300">
      ...
      <header className="flex items-center justify-between px-6 py-4 b order-b b order-slate-200 dark:b order-white/10 bg-white/90 dark:bg-[#0d0d0f]/90 backdrop-blur-md sticky top-0 z-50">
        ...
        <nav className="hidden lg:flex items-center gap-8 text-[14px] font-semibold text-slate-600 dark:text-slate-300">
          ...
          <Link href="/platform/policies" className="text-blue-600 dark:text-blue-400 transition-colors">Policy Engine</Link>
      ...
      <main className="pb-0">
        ...
        <section className="relative max-w-[1400px] mx-auto px-6 md:px-12 pt-16 md:pt-28 pb-20 overflo w-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl z-10">
              ...
              >
                <div className="w-5 h-5 rounded flex items-center justify-center bg-blue-100 dark:bg-blue-800">
                  <ScrollText className="w-3 h-3 text-blue-600 dark:text-blue-300" />
                </div>
              ...
              >
                Stop guessing what your AI might do. Write clear, irrefutable ALLOW and BLOCK rules based on real-time context, user roles, and operational risk boundaries.
              </motion.p>
            ...
            {/* ABSTRACT POLICY BUILDER GRAPHIC */}
            <motion.div
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 b order-b b order-slate-100 dark:b order-white/5 bg-slate-50/50 dark:bg-transparent">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[15px] font-bold text-slate-900 dark:text-white">Rule: protect_pii_data</div>
                    <div className="text-[12px] text-slate-500 font-mono">Status: Enforced globally</div>
                  </div>
                </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-stretch gap-3">
                  <div className="pt-2">
                    <div className="px-2 py-1 rounded bg-slate-100 dark:bg-white/10 text-slate-600 dark:text-slate-400 text-[11px] font-bold uppercase tracking-widest">IF</div>
                  </div>
                  <div className="flex-1 p-3 rounded-lg border b order-slate-200 dark:b order-white/10 bg-slate-50 dark:bg-white/5 flex items-center gap-2">
                    <span className="text-[14px] font-mono text-blue-600 dark:text-blue-400">agent.action</span>
                    <span className="text-[14px] text-slate-400">==</span>
                    <span className="text-[14px] font-mono text-blue-600 dark:text-blue-400">&quot;database_query&quot;</span>
                  </div>
                </div>
                ...
                <div className="flex items-stretch gap-3">
                  <div className="pt-2">
                    <div className="px-2 py-1 rounded bg-slate-100 dark:bg-white/10 text-slate-600 dark:text-slate-400 text-[11px] font-bold uppercase tracking-widest">AND</div>
                  </div>
                  <div className="flex-1 p-3 rounded-lg border b order-slate-200 dark:b order-white/10 bg-slate-50 dark:bg-white/5 flex items-center gap-2">
                    <span className="text-[14px] font-mono text-blue-600 dark:text-blue-400">payload.contains_pii</span>
                    <span className="text-[14px] text-slate-400">==</span>
                    <span className="text-[14px] font-mono text-blue-600 dark:text-blue-400">true</span>
                  </div>
                </div>

                <div className="h-4 b order-l-2 b order-dashed b order-slate-200 dark:b order-white/10 ml-5"></div>

                {/* Outcome */}
                <div className="flex items-stretch gap-3">
                  <div className="pt-2">
                    <div className="px-2 py-1 rounded bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border b order-blue-200 dark:b order-blue-800/50 text-[11px] font-bold uppercase tracking-widest">THEN</div>
                  </div>
                  <div className="flex-1 p-3 rounded-lg border b order-blue-200 dark:b order-blue-900/30 bg-blue-50 dark:bg-blue-900/10 flex items-center gap-3">
                    <ShieldAlert className="w-5 h-5 text-blue-500" />
                    <span className="text-[14px] font-bold text-blue-700 dark:text-blue-400">BLOCK_EXECUTION</span>
                  </div>
                </div>
          ...
          <div className="max-w-[1400px] mx-auto px-6 md:px-12">
            <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              <p className="text-[18px] text-slate-600 dark:text-slate-400">
                Write, test, and deploy security policies just like software. Aegisora provides the framework to turn abstract compliance rules into hard technical boundaries.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white dark:bg-[#111113] border b order-slate-200 dark:b order-white/10 p-8 rounded-2xl">
                ...
                <h3 className="text-[20px] font-bold text-slate-900 dark:text-white mb-3">Context-Aware Rules</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Evaluate conditions not just on the raw prompt, but on active user session data, geographical location, and current threat levels.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-[#111113] border b order-slate-200 dark:b order-white/10 p-8 rounded-2xl">
                ...
                <h3 className="text-[20px] font-bold text-slate-900 dark:text-white mb-3">Compliance Mapping</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Map your technical rules directly to compliance standards like ISO 26262, SOC 2, or HIPAA to automatically generate audit readiness reports.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-[#111113] border b order-slate-200 dark:b order-white/10 p-8 rounded-2xl">
                ...
                <h3 className="text-[20px] font-bold text-slate-900 dark:text-white mb-3">Version Control</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Every policy change is tracked. Run &quot;dry-run&quot; tests against historical agent logs to prevent breaking changes, and instantly rollback if needed.
                </p>
              </div>
            </div>
          </div>
