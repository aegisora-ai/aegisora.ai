    ...
    <div className="min-h-screen bg-[#000000] text-[#f4f4f5] font-sans flex flex-col selection:bg-[#0051c3]/30">
        ...
        <div className="flex items-center gap-3 relative">
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-1.5 text-[13px] font-medium text-[#a1a1aa] hover:text-white transition-colors bg-transparent border b order-transparent hover:b order-[#27272a] px-3 py-1.5 rounded-md outline-none"
            >
            ...
            <AnimatePresence>
              {isLangOpen && (
                <motion.div
                  ...
                  className="absolute right-0 top-full mt-1 w-40 bg-[#18181b] border b order-[#27272a] rounded-lg shado w-2xl py-2 z-50"
                >
                  {LANGUAGES.map(lang => (
                    <button
                      key={lang}
          ...
          <Link href="#" className="border b order-[#27272a] hover:bg-[#18181b] text-[13px] font-medium text-white px-4 py-1.5 rounded-md transition-colors outline-none">
            Support
          </Link>
        </div>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 w-full max-w-[440px] mx-auto z-10 pb-12 pt-4">
        ...
        <div className="w-full flex flex-col gap-3 mb-6">
          <button className="w-full flex items-center justify-center gap-2 bg-transparent border b order-[#3f3f46] hover:bg-[#18181b] rounded-md py-2.5 transition-colors outline-none">
        ...
        <form className="w-full flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              type="email"
              className="w-full bg-[#111113] border b order-[#3f3f46] focus:b order-[#0051c3] rounded-md px-3 py-2 text-[14px] text-white outline-none transition-colors"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input
                type="password"
                className="w-full bg-[#111113] border b order-[#3f3f46] focus:b order-[#0051c3] rounded-md pl-3 pr-10 py-2 text-[14px] text-white outline-none transition-colors"
              />
          ...
          <label className="flex items-center gap-2 mt-1 cursor-pointer group w-fit">
            <div className="w-4 h-4 rounded border b order-[#3f3f46] bg-white flex items-center justify-center">
          ...
          <div className="mt-2">
            ...
            <div className="w-full border b order-[#3f3f46] bg-[#1c1c1f] rounded-md p-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <button
                  type="button"
                  onClick={handleVerify}
                  className={`w-6 h-6 rounded border flex items-center justify-center transition-colors outline-none ${isVerified ? 'b order-[#0051c3] bg-[#0051c3]/10' : 'b order-[#52525b] hover:b order-white'}`}
                >
          ...
          <div className="mt-4 flex flex-col gap-4">
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <div className="w-4 h-4 rounded border b order-[#3f3f46] bg-transparent flex items-center justify-center mt-0.5 flex-shrink-0 group-hover:b order-[#0051c3] transition-colors">
              </div>
      ...
      {/* FOOTER */}
      <footer className="w-full py-6 flex flex-col items-center justify-center gap-4 mt-auto b order-t b order-[#27272a] bg-[#000000]">
