  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="max-w-md w-full bg-zinc-900/50 border border-zinc-800 p-8 rounded-2xl backdrop-blur-xl relative z-10 shadow-2xl text-center space-y-6"
      >
        {/* Onay İkonu */}
        <div className="w-16 h-16 bg-emerald-950/40 border border-emerald-800/50 rounded-full flex items-center justify-center mx-auto text-emerald-400 text-2xl">
          ✓
        </div>

        <div>
          <span className="text-xs uppercase tracking-widest text-emerald-400 font-semibold bg-emerald-950/40 px-3 py-1 rounded-full border border-emerald-800/50">
            Access Granted
          </span>
        ...
        <div className="pt-2">
          <Link
            ...
            className="w-full inline-block bg-white text-black font-medium py-3 rounded-xl hover:bg-zinc-200 transition-colors text-sm tracking-wide text-center shadow-lg"
          >
