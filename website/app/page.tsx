  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FAFAFA] font-sans">
      ...
      <main className="flex-1">
        ...
        <section className="pt-20 md:pt-32 pb-16 bg-[#FAFAFA] px-4">
          <div className="max-w-[1000px] mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/platform" className="w-full sm:w-auto px-8 py-3.5 text-[15px] font-bold text-slate-900 bg-[#FFC107] hover:bg-[#FFCA28] rounded-lg shadow-sm transition-colors">
                Aegisora OSS
              </Link>
              <Link href="/contact" className="w-full sm:w-auto px-8 py-3.5 text-[15px] font-bold text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 rounded-lg shadow-sm transition-colors">
                Talk to Us
              </Link>
            </div>
          </div>
        ...
        {/* ========================================= */}
        <div className="w-full h-[250px] md:h-[350px] relative overflow-hidden border-y border-slate-200 shadow-[inset_0_0_50px_rgba(0,0,0,0.05)]">
          <AnimatedBlueWave />
        </div>
        ...
        {/* ========================================= */}
        <section className="py-20 md:py-32 bg-[#FAFAFA] border-b border-slate-200 px-6">
        ...
        {/* ========================================= */}
        <section className="py-24 bg-white border-b border-slate-200 px-6 overflow-hidden">
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">

            {/* Sol: Abstract UI (Heatmap Matrix) */}
            <div className="relative w-full aspect-square md:aspect-[4/3] bg-[#FAFAFA] rounded-2xl border border-slate-200 p-8 flex flex-col justify-between overflow-hidden group">
              ...
              <div className="relative z-10 bg-white border border-slate-200 rounded-xl p-4 shadow-lg self-start mt-8">
        ...
        {/* ========================================= */}
        <section className="py-24 bg-[#FAFAFA] border-b border-slate-200 px-6 overflow-hidden">
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2 relative w-full aspect-square md:aspect-[4/3] bg-white rounded-2xl border border-slate-200 flex items-center justify-center overflow-hidden">
              <div className="absolute w-[80%] h-[80%] border-2 border-dashed border-slate-200 rounded-full animate-[spin_30s_linear_infinite]"></div>
              <div className="absolute w-[50%] h-[50%] border-2 border-slate-100 rounded-full animate-[spin_20s_linear_infinite_reverse]"></div>

              <div className="absolute w-4 h-4 bg-emerald-400 rounded-full top-[20%] left-[20%] shadow-[0_0_20px_rgba(52,211,153,0.5)]"></div>
              <div className="absolute w-6 h-6 bg-[#0066FF] rounded-full bottom-[20%] right-[30%] shadow-[0_0_30px_rgba(0,102,255,0.4)]"></div>
              <div className="absolute w-3 h-3 bg-rose-400 rounded-full top-[40%] right-[20%] shadow-[0_0_15px_rgba(251,113,133,0.5)]"></div>

              <div className="z-10 bg-white/90 backdrop-blur border border-slate-200 rounded-xl p-6 shadow-xl text-center">
        ...
        {/* ========================================= */}
        <section className="py-24 bg-white border-b border-slate-200 px-6 relative overflow-hidden">
        ...
        <section className="py-24 bg-[#FAFAFA] px-6">
          <div className="max-w-[1200px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Card 1 */}
              <Link href="/blog" className="group block bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
