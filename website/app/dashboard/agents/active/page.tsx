...
export default function ActiveAgentsPage() {
  ...
  const filteredAgents = agents.filter(a => {
    const matches = a.name.toLowerCase().includes(searchQuery.toLowerCase()) || a.role.toLowerCase().includes(searchQuery.toLowerCase()); return matches && a.status === "active";
  });
    ...
    <div className="flex flex-col animate-in fade-in duration-300">
      <div className="flex items-center justify-between gap-4 mb-6">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            type="text" placeholder="Search active agents..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}
