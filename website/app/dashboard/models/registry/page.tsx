          ...
          <table className="w-full text-left border-collapse whitespace-nowrap">
            ...
            <tbody>
              {filteredModels.map((model) => (
                <tr key={model.id} className="border-b border-border/40 hover:bg-[#18181b]/80 transition-colors cursor-pointer group">
                  <td className="px-5 py-3">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded bg-[#09090b] border border-border flex items-center justify-center">
                  ...
                  <td className="px-5 py-3">
                    {model.status === 'Active' ? (
                      ...
                      <span className="flex items-center gap-1.5 text-[11px] font-medium text-orange-400 bg-orange-500/10 border border-orange-500/20 px-2 py-0.5 rounded w-fit">
