        ...
        <div className="flex flex-col gap-5">
          {quotas.map((q, idx) => (
            <div key={idx} className="flex flex-col gap-2">
              ...
              <div className="h-2 w-full bg-[#09090b] rounded-full overflow-hidden border border-border">
                <div
              ...
              {filteredEvents.map((ev) => (
                <tr key={ev.id} className="border-b border-border/40 hover:bg-[#18181b]/80 transition-colors cursor-pointer group">
                  ...
                  <td className="px-5 py-3">
                    <span className={`text-[11px] font-medium px-2 py-0.5 rounded border ${ev.action.includes('Blocked') ? 'bg-decision-block/10 text-decision-block border-decision-block/20' : 'bg-decision-escalate/10 text-decision-escalate border-decision-escalate/20'}`}>
                      {ev.action}
                    </span>
                  </td>
